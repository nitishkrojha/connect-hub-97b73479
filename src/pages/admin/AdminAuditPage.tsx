...
const logs = [
  { id: 1, user: "Admin User", action: "Created project", details: 'Created "RetailPro" project', timestamp: "Jun 9, 2025 14:32", type: "project" },
  ...
  { id: 7, user: "Admin User", action: "User created", details: 'Created user "Vikram J." for RetailPro', timestamp: "Jun 8, 2025 15:10", type: "user" },
  { id: 8, user: "Anita R.", action: "Login", details: "Logged in from 192.168.1.105", timestamp: "Jun 8, 2025 14:00", type: "login" },
  { id: 9, user: "Admin User", action: "Quota updated", details: 'HealthLink: Monthly limit changed 15,000 → 20,000', timestamp: "Jun 7, 2025 10:30", type: "config" },
